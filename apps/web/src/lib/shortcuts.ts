...
export const DEFAULT_SHORTCUTS: ShortcutDef[] = [
  ...
  { id: "close-topic", keys: isMac ? "Cmd+D" : "Ctrl+D", description: "토픽 닫기 (읽기 전용)", scope: "panel" },
  { id: "reopen-tab", keys: isMac ? "Cmd+Shift+T" : "Ctrl+Shift+T", description: "마지막 닫은 토픽 다시 열기", scope: "panel" },
  ...
  { id: "switch-tab-4", keys: isMac ? "Cmd+4" : "Alt+4", description: "탭 4로 이동", scope: "panel" },
  { id: "switch-tab-5", keys: isMac ? "Cmd+5" : "Alt+5", description: "탭 5로 이동", scope: "panel" },
  { id: "switch-tab-6", keys: isMac ? "Cmd+6" : "Alt+6", description: "탭 6로 이동", scope: "panel" },
